...
title: "アカウントの作成と設定"
quiz:
  - question: "GitHubアカウント作成時のパスワード要件として正しいものはどれですか?"
    options:
      - "8文字以上の英数字のみ"
      - "15文字以上、または8文字以上で数字と小文字を含む"
      - "12文字以上で記号を含む"
      - "10文字以上で大文字・小文字・数字を含む"
    answer: 1
  - question: "2要素認証(2FA)の認証方法として最も推奨されるものはどれですか?"
    options:
      - "SMS認証"
      - "メール認証"
      - "認証アプリまたはセキュリティキー"
      - "秘密の質問"
    answer: 2
  - question: "SSH鍵でGitHubに接続する主なメリットはどれですか?"
    options:
      - "通信速度が速くなる"
      - "毎回パスワードを入力せずに通信できる"
      - "より多くのリポジトリにアクセスできる"
