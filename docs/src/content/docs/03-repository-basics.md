...
title: "リポジトリの基本"
quiz:
  - question: "リポジトリのPublicとPrivateの違いについて正しいものはどれですか?"
    options:
      - "Publicは無料、Privateは有料"
      - "Publicは誰でも閲覧可能、Privateは招待されたユーザーのみ"
      - "Publicは100MBまで、Privateは無制限"
      - "Publicはバックアップなし、Privateはバックアップあり"
    answer: 1
  - question: ".gitignoreファイルの役割はどれですか?"
    options:
      - "リポジトリの説明を記載する"
      - "Gitの追跡対象から除外するファイルを指定する"
      - "ライセンス情報を定義する"
      - "コミットメッセージのテンプレートを設定する"
    answer: 1
  - question: "フォーク(Fork)とクローン(Clone)の違いとして正しいものはどれですか?"
    options:
      - "フォークはローカルにコピー、クローンはGitHub上にコピー"
      - "フォークはGitHub上にコピー、クローンはローカルにコピー"
      - "フォークは有料機能、クローンは無料機能"
      - "フォークとクローンは同じ操作"
    answer: 1
---
